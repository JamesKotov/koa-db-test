...
2. При получении списка книг, для каждой книги возвращается массив только с идентификаторами авторов, самих авторов 
следует получать отдельными запросами к API
